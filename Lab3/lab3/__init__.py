...
from lab3.vacuum import VacuumEnvironment, ENV_CLEAN, ENV_DIRTY, ENV_WALL
from lab3.myvacuumagent import MyVacuumAgent
from lab3.randomvacuumagent import RandomVacuumAgent
from lab3.reactivevacuumagent import ReactiveVacuumAgent
...
class Lab3:
    """
    VacuumEnvironment GUI. Handles all GUI functionality and sim
    """
    ...
    def __init__(self):
        ...
        self.agent_img = dict()
        self.agent_img[(1, 0)] = PhotoImage(file="images/vacuum_cleaner_east.png")
        self.agent_img[(0, 1)] = PhotoImage(file="images/vacuum_cleaner_south.png")
        self.agent_img[(-1, 0)] = PhotoImage(file="images/vacuum_cleaner_west.png")
        self.agent_img[(0, -1)] = PhotoImage(file="images/vacuum_cleaner_north.png")
        ...
        self.vacuum_env: VacuumEnvironment = None
    ...
    def create_sim(self):
        ...
        """
        venv = VacuumEnvironment(*self.grid_dims_getter(), self.dirt_bias_getter(), self.wall_bias_getter(), self.seed_getter())
...
run = lambda: Lab3().start_main_loop()
